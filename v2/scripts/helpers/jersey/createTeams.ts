...
(async () => {
  ...
  const teamData: iTeam[] = [
    ...
    { name: "Frisbee", shareable: false } as iTeam,
    { name: "Handball M", shareable: false } as iTeam,
    { name: "Handball F", shareable: false } as iTeam,
    { name: "Netball", shareable: true } as iTeam,
    { name: "Road Relay M", shareable: true } as iTeam,
    { name: "Road Relay F", shareable: true } as iTeam,
    { name: "Soccer M", shareable: false } as iTeam,
    { name: "Soccer F", shareable: false } as iTeam,
    ...
    { name: "Touch Rugby M", shareable: false } as iTeam,
    { name: "Touch Rugby F", shareable: false } as iTeam,
