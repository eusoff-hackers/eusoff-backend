            ...
            <tr>
                <td align="center" valign="top" style="padding: 5% 10px;">
                    <table width="600" border="0" cellspacing="0" cellpadding="20" bgcolor="#ffffff" style="border-radius: 8px; box-shadow: 0px 2px 8px rgba(0, 0, 0, 0.1);">
                        <tr>
                            <td>
                                <h2 style="margin-bottom: 30px; color: #333;">Jersey Bidding is almost here!</h2>
                                <p style="margin-bottom: 20px; color: #666; line-height: 1.6;">It's the time of the year for Jersey Bidding! We will be in charge of conducting Jersey Bidding. Here are your account details:</p>
