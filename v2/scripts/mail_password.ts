                    ...
                    <table width="600" border="0" cellspacing="0" cellpadding="20" bgcolor="#ffffff" style="border-radius: 8px; box-shadow: 0px 2px 8px rgba(0, 0, 0, 0.1);">
                        <tr>
                            <td>
                                ...
                                <p style="margin-bottom: 20px; color: #666; line-height: 1.6;">Eusoff Hackers is back with Jersey Bidding! Here are your account details for bidding:</p>
                                ...
                                <p style="margin-bottom: 20px; color: #666; line-height: 1.6;">You will be able to log in to the site and bid for jerseys on your respective round. Stay tuned to Channel EH!</p>
...
(async () => {
  ...
  parse(
    ...
    async (error, result: Data[]) => {
      console.error(error);
      mail(result.filter((u) => ["A0259080A"].includes(u.username))[0]);
